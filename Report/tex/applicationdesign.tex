...
A decision was made to structure surveys modularly. Doing so makes it much easier to create, rearrange and reuse whole surveys and/or their parts. It also makes sense to create questions as independent entities (i.e. not bound to a single survey). This way, individual questions could be (re)used across multiple surveys. To make this possible, as mentioned in section \ref{subsec:surveynavigation}, references to actual questions are used.
